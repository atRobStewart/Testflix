...
| Note that it may be difficult to make out in the recording, on my own laptop it is not as clear as it was on my TV. |
...
| Description |
| :-- |
| While attacking the Desert Djinn I got slowly cornered with no way out. This happened due to a combination of the enemy pressing its attack and me pulling him closer to me with the Deadly Embrace stagger attack. |
| It's a slow build but at the 40 second mark in the video you can see that I am clearly trapped with no way out. |
| This causes the camera to push in from its usual resting distance to being right on top of the action scene. This causes the enemy to no longer render on camera and makes Clive difficult to as well as making the overall fight tougher to beat. |
| I failed to move the camera around 180 degrees roughly to where my allies were standing, but I do suspect that the camera would have returned to its usual distance from Clive. |
